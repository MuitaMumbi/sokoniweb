        ...
        <>
            ...
            <div className="main-layout">
                ...
                <section id="about" style={{
                    ...
                    <div style={{
                        ...
                        <div>
                            ...
                            <p style={{ fontSize: 15, color: T.gray500, lineHeight: 1.8, marginBottom: 16 }}>
                            ...
                            <p style={{ fontSize: 15, color: T.gray500, lineHeight: 1.8 }}>
                                Founded in Nairobi, we serve supermarkets, wholesalers, and growing retail businesses across Kenya, Tanzania, Uganda, Rwanda, and Ethiopia.
                            </p>
                        </div>
                        <div style={{
                            display: "grid",
                            ...
                            {[
                                ...
                                <div key={sub} style={{
                                    ...
                                    <div style={{ fontSize: isMobile ? 24 : 32, marginBottom: 8 }}>{icon}</div>
                                    <div style={{
                                        fontFamily: "'Plus Jakarta Sans', sans-serif",
                ...
                <section id="delivery" style={{
                    ...
                    {/* Delivery zones table — scrollable on mobile */}
                    <div style={{
                        background: "white", borderRadius: 14,
                        overflow: "hidden",
                        boxShadow: "0 2px 8px rgba(10,46,110,0.06)",
                        ...
                        <div style={{
                            background: T.blue, padding: "14px 20px",
                            fontFamily: "'Plus Jakarta Sans', sans-serif",
                                ...
                                <tbody>
                                    {[
                                        ...
                                        <tr key={zone} style={{
                                            ...
                                            <td style={{ padding: "12px 16px", fontSize: 13, fontWeight: 700, color: T.blue, whiteSpace: "nowrap" }}>{zone}</td>
                                            <td style={{ padding: "12px 16px", fontSize: 13, color: T.gray500 }}>{area}</td>
                                            <td style={{ padding: "12px 16px", fontSize: 13, color: T.gray500, whiteSpace: "nowrap" }}>{time}</td>
                                            <td style={{ padding: "12px 16px", fontSize: 13, fontWeight: 600, color: T.blue, whiteSpace: "nowrap" }}>{min}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
                        ...
                        <div style={{
                            ...
                            {[
                                ...
                                <div key={label} style={{
                                    ...
                                    <div>
                                        <div style={{ fontSize: 12, color: T.gray500, marginBottom: 2 }}>{label}</div>
                                        <div style={{ fontSize: 14, fontWeight: 600, color: T.blue }}>{value}</div>
                                    </div>
                                </div>
                            ))}
                        </div>
                            ...
                            {[
                                ...
                                <div key={label} style={{ marginBottom: 12 }}>
                                    <label style={{
                                        ...
                                        fontWeight: 600, color: T.gray500, marginBottom: 5,
                                    }}>
                                        {label}
                                    </label>
                                    <input
                    ...
                    <div style={{
                        ...
                        <div>
                            <h3 style={{
                                fontFamily: "'Plus Jakarta Sans', sans-serif",
                                fontSize: isMobile ? 20 : 24,
                                fontWeight: 800, color: T.white, marginBottom: 8,
                            }}>
